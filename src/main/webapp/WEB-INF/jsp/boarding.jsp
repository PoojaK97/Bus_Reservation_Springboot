...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      <h1 style="color:#4c4cff">Enter Details
      </h1>
      <hr>
      ...
      <div id="addEmployee">
		<form:form action="/addpassenger" method="post"
			...
			<p>
				<label>Contact: </label>
				<form:input type='number' minlength='10' size='10' path="contact" required='true'/>
			</p>
			<p>
			...
			<p>
				...
				<form:input type='number' path="tickets" required='true'/>
			</p>
