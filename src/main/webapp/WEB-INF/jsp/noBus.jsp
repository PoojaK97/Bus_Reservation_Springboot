...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      <h1 style="color:#4c4cff">Sorry!
      
      </h1>
      <hr>
		<p>There are no buses available according to your query. Kindly modify your search and retry.
		</p>
      <hr>
      <a style="margin-left: 10px;" href="${pageContext.request.contextPath}/bookticket" class="btn btn-warning" role="button">BACK</a>
    </div>
    <div class="col-sm-2 sidenav">
