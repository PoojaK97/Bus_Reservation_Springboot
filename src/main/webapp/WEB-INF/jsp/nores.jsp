...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      ...
      <hr>
		<p>There is no reservation under this ID. Kindly modify your search and try.
		</p>
      <hr>
      <a style="margin-left: 10px;" href="${pageContext.request.contextPath}/checkreservation" class="btn btn-warning" role="button">BACK</a>
    </div>
    <div class="col-sm-2 sidenav">
