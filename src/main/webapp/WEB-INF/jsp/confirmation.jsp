...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      <h1 style="color:#4c4cff">Booking Confirmed
      
      </h1>
      <hr>
		<p>Your booking ID is ${id}. You will be notified through email and sms.
		</p>
      <hr>
      <a style="margin-left: 10px;" href="${pageContext.request.contextPath}/welcome" class="btn btn-warning" role="button">HOME</a>
    </div>
    <div class="col-sm-2 sidenav">
